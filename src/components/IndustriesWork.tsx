          ...
          <div className="flex items-center gap-5 mt-6 md:mt-0">
            {active && (
              <button
                ...
                className="font-mono text-[10px] tracking-[0.16em] uppercase text-[rgba(var(--ch-text),0.45)] hover:text-[var(--color-accent)] transition-colors duration-200"
              >
                ← All industries
              </button>
            )}
            <Link
              ...
              className="font-mono text-[10px] tracking-[0.16em] uppercase text-[rgba(var(--ch-text),0.55)] hover:text-[var(--color-accent)] transition-colors duration-200"
            >
              All case studies →
            </Link>
          </div>
            ...
            return (
              <button
                ...
                className={[
                  ...
                  isActive ? 'ring-1 ring-[var(--color-green)]' : '',
                ].join(' ')}
              ...
              >
                ...
                <span
                  ...
                  style={{
                    ...
                    color: isActive ? 'rgba(var(--ch-green),0.14)' : 'rgba(255,255,255,0.05)',
                  }}
                  aria-hidden="true"
                >
                ...
                <div className="relative z-10 h-full flex flex-col justify-between p-5">
                  <span
                    className={[
                      ...
                      isActive ? 'text-[var(--color-green)]' : 'text-[rgba(255,255,255,0.22)]',
                    ].join(' ')}
                  >
                    {String(i + 1).padStart(2, '0')}
                  </span>
        ...
        >
          {filtered.length === 0 ? (
            <div className="col-span-full py-20 text-center border border-dashed border-[rgba(var(--ch-accent),0.15)]">
              ...
              <Link
                href="/contact"
                className="inline-block font-mono text-[10px] tracking-[0.14em] uppercase bg-[var(--color-accent)] text-white px-8 py-3.5 hover:bg-[var(--color-accent-hover)] transition-colors duration-200"
              >
            ...
            filtered.map((cs, i: number) => (
              ...
              >
                ...
                <div className="p-7">
                  ...
                  <h3
                    className="font-serif font-bold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-accent)] transition-colors duration-200 leading-tight"
                  ...
                  <div className="pt-5 border-t border-[rgba(var(--ch-accent),0.08)] flex items-baseline gap-3">
                    ...
                    <span className="ml-auto font-mono text-[12px] text-[rgba(var(--ch-text),0.20)] group-hover:text-[var(--color-accent)] group-hover:translate-x-1 transition-all duration-200">
                      →
                    </span>
                  </div>
                </div>
